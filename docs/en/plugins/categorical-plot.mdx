...
|---|---|---|---|
| `position` | `'left' \| 'right'` | `'left'` | Which side the value axis is on |
| `categoryAxis` | `CategoryAxis` | see below | Category axis settings |
| `valueAxis` | `ValueAxis` | see below | Value axis settings |
