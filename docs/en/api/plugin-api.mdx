...
> **Tip**: Layer names are always capitalized (`Bar`, `ValueAxis`); Plugin-level params are lowercase (`valueAxis`, `categoryAxis`). Both can appear in the same params object.
